return {
	...
	keys = {
		...
		{ "<C-A-Left>", function() require("smart-splits").swap_buf_left() end, desc = "Swap buffer left", mode = "n", },
		{ "<C-A-Down>", function() require("smart-splits").swap_buf_down() end, desc = "Swap buffer down", mode = "n", },
		{ "<C-A-Up>", function() require("smart-splits").swap_buf_up() end, desc = "Swap buffer up", mode = "n", },
		{ "<C-A-Right>", function() require("smart-splits").swap_buf_right() end, desc = "Swap buffer right", mode = "n", },
	},
}
