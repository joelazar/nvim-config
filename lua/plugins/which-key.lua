	...
	local config = {
		...
		vmappings = {
			...
			["c"] = {
				...
				["g"] = {
					...
					["d"] = { "<cmd>ChatGPTRun grammar_correction danish<CR>", "Danish" },
					["e"] = { "<cmd>ChatGPTRun grammar_correction english<CR>", "English" },
					["h"] = { "<cmd>ChatGPTRun grammar_correction hungarian<CR>", "Hungarian" },
				},
				...
				["t"] = {
					name = "Translate",
					["d"] = { "<cmd>ChatGPTRun translate danish<CR>", "Danish" },
					["e"] = { "<cmd>ChatGPTRun translate english<CR>", "English" },
					["h"] = { "<cmd>ChatGPTRun translate hungarian<CR>", "Hungarian" },
				},
		...
		mappings = {
			...
			["c"] = {
				...
				["t"] = {
					name = "Translate",
					["d"] = { "<cmd>ChatGPTRun translate danish<CR>", "To danish" },
					["e"] = { "<cmd>ChatGPTRun translate english<CR>", "To english" },
					["h"] = { "<cmd>ChatGPTRun translate hungarian<CR>", "To hungarian" },
				},
				["x"] = { "<cmd>ChatGPTRun explain_code<CR>", "Explain Code" },
			},
